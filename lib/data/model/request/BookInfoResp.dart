...
//  flutter_books_app
//
//  Created by jsjzx on 2020-03-13.
...
class BookInfoResp {
  ...
  BookInfoResp.fromParms({this.banned, this.buytype, this.chaptersCount, this.currency, this.followerCount, this.latelyFollower, this.postCount,
    this.safelevel, this.serializeWordCount, this.sizetype, this.gg, this.le, this.advertRead, this.allowBeanVoucher, this.allowFree, this.allowVoucher,
    this.hasCp, this.isAllowNetSearch, this.isFineBook, this.isForbidForFreeApp, this.isSerial, this.limit, this.id, this.author, this.authorDesc, this.cat,
    this.contentType, this.copyrightDesc, this.cover, this.creater, this.lastChapter, this.longIntro, this.majorCate, this.majorCateV2, this.minorCateV2, this.minorCate,
    this.originalAuthor, this.retentionRatioX, this.superscript, this.title, this.updated, this.anchors, this.gender, this.tags, this.rating
  });
...
class RatingBean {
  ...
  RatingBean.fromParemas({this.count, this.score, this.isEffect});
